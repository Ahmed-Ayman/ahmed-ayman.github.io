...
import { FaHome, FaSearch, FaEnvelope, FaTag, FaUser, FaRss, FaDrupal,FaSymfony ,FaBlog} from "react-icons/fa/";
...
class Menu extends React.Component {
  constructor(props) {
    ...
    this.items = [
      ...
      { to: "/tag/drupal", label: "Drupal", icon: FaDrupal },
      { to: "/tag/symfony", label: "Symfony", icon: FaSymfony },
      { to: "/tag/article", label: "Articles", icon: FaBlog },
